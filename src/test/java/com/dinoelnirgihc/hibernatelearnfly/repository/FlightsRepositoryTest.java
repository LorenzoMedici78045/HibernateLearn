...
class FlightsRepositoryTest {
    ...
    void findAllFlightsCriteria()
    {
        try(SessionFactory sessionFactory = HibernateTestUtil.buildSessionFactory())
        {
            ...
            session.persist(a4);
            session.persist(f1);
            FR.findAllFlightsCriteria(session);
        }
        catch(Exception e)
        {
            System.err.println("Initial SessionFactory creation failed." + e);
    ...
    @Test
    void findFlightByFlightNumberCriteria()
    {
        try(SessionFactory sessionFactory = HibernateTestUtil.buildSessionFactory())
        {
            Session session = sessionFactory.openSession();
            ...
            session.persist(a4);
            session.persist(f1);
            FR.findFlightByFlightNumberCriteria(session, "75463");
        }
        catch(Exception e)
        {
            System.err.println("Initial SessionFactory creation failed." + e);
    ...
    @Test
    void findAllFlightsByAircraftIdCriteria()
    {
        try(SessionFactory sessionFactory = HibernateTestUtil.buildSessionFactory())
        {
            Session session = sessionFactory.openSession();
            ...
            session.persist(a4);
            session.persist(f1);
            FR.findAllFlightsByAircraftIdCriteria(session, 1L);
        }
        catch(Exception e)
        {
            System.err.println("Initial SessionFactory creation failed." + e);
    ...
    @Test
    void findAllFlightsByAircraftIdWithFlightNumberCriteria()
    {
        try(SessionFactory sessionFactory = HibernateTestUtil.buildSessionFactory())
        {
            Session session = sessionFactory.openSession();
            ...
            session.persist(a4);
            session.persist(f1);
            FR.findAllFlightsByAircraftIdWithFlightNumberCriteria(session, 1L, "75463");
        }
        catch(Exception e)
        {
            System.err.println("Initial SessionFactory creation failed." + e);
