...
class TicketFlightsRepositoryTest {
    ...
    @Test
    void findAllTicketFlightsQueryDsl()
    {
        try(SessionFactory sessionFactory = HibernateTestUtil.buildSessionFactory())
        {
            Session session = sessionFactory.openSession();
            ...
            tFR.findAllTicketFlightsQueryDsl(session);
        }
        catch(Exception e)
        {
            System.err.println("Initial SessionFactory creation failed." + e);
    ...
    @Test
    void findAllTicketFlightsByAmountQueryDsl()
    {
        try(SessionFactory sessionFactory = HibernateTestUtil.buildSessionFactory())
        {
            Session session = sessionFactory.openSession();
            ...
            tFR.findAllTicketFlightsByAmountQueryDsl(session, new BigDecimal(10543));
        }
        catch(Exception e)
        {
            System.err.println("Initial SessionFactory creation failed." + e);
    ...
    @Test
    void findAllTicketFlightsByFlightIdQueryDsl()
    {
        try(SessionFactory sessionFactory = HibernateTestUtil.buildSessionFactory())
        {
            Session session = sessionFactory.openSession();
            ...
            tFR.findAllTicketFlightsByFlightIdQueryDsl(session, 1L);
        }
        catch(Exception e)
        {
            System.err.println("Initial SessionFactory creation failed." + e);
